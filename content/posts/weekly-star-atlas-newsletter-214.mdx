...
During the [Atlas Brew](https://www.youtube.com/watch?v=stqqz8li9%5FY), John (aka Xcode – Product Manager) showed some new combat-related visuals and provided an example of a quest monologue. Jose (Chief Noot and Lore Guardian), meanwhile, shared some AI-generated teasers on X. Let’s go over it all!
...
Below are the two screenshots shared by John. You can hear more about these during the last 15 minutes of [last week’s Atlas Brew](https://www.youtube.com/watch?v=stqqz8li9%5FY).
...
Last week saw the (delayed) first [Economic Forum of 2026](https://www.youtube.com/watch?v=jGj%5F81l3-7g), which focused mainly on the initial results of the new _Open Marketplace Operations_ (OMO) program.
...
If you want to learn more about all of this, make sure to check out the [recording](https://www.youtube.com/watch?v=jGj%5F81l3-7g)!
