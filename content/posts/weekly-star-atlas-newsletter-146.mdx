...
The team is expected to introduce a novel on-chain voting system, dubbed Ranked-choice Voting, or more specifically, [Single Transferable Vote](https://en.wikipedia.org/wiki/Single%5Ftransferable%5Fvote).
