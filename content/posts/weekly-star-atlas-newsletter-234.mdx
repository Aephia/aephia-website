...
Additional Session 0s are planned with the other players the day after, but these will likely be private.
...
However, the team shared that the assets will remain available for purchase at the same price points, so the 25% discount will remain in effect. They did not specify how long this offer would last.
