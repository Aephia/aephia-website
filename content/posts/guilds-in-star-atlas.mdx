...
Over time, as the number of guilds grew, a few players decided to try to come up with an alternative. The only one of these that has seen some more recent updates is the website: <https://staratlasguilds.com>
